...
export async function getConversionData(registrations){
 ...
 return {configured:true,config,matches,possibleMatches,mondayItems:items.length,board:resolved.board,detected:resolved.detected,orientationGroup:{id:orientation.id,title:orientation.title}};
}
