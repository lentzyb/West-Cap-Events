...
const required = [
  ...
  "netlify/functions/referrers.mjs","netlify/functions/registrations.mjs","netlify/functions/webhook-client.mjs"
];
for (const file of required) await access(file);
console.log("WCL Event Platform webhook edition is ready.");
