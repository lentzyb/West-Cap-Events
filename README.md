...
## Orientation + Active Roster deduplication
Recruiting analytics now reads both Monday groups. Candidates are deduplicated before event attribution and saved permanently by Monday item ID, so a move from Orientation to Active Roster does not double count the recruit.
